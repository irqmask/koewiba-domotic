...
void test_write(uint32_t uAddress, uint8_t uByte, void* pvArg)
{
...
void IHEXTEST_vTestFileRead(void)
{
    ...
    retval = ihex_read_file("testdata/ihex/data_normal.hex", &startaddress, &g_firstaddress, &g_lastaddress, NULL, NULL);
...
void IHEXTEST_vTestFileReadToMemory(void)
{
    ...
    g_firstaddress = 0xFFFFFFFF; g_lastaddress = 0x00000000;
    retval = ihex_read_file("testdata/ihex/data_normal.hex", NULL, NULL, NULL, test_write, NULL);
    CU_ASSERT(retval == e_ihex_success);
    CU_ASSERT(g_firstaddress == 0x00000000);
    CU_ASSERT(g_lastaddress  == 0x0000315B);
    free(g_memory);
...
void IHEXTEST_vTestFileWithSegmentOffset(void)
{
    ...
    g_firstaddress = 0xFFFFFFFF; g_lastaddress = 0x00000000;
    // successfully read an ihex file without saving the data
    retval = ihex_read_file("testdata/ihex/data_with_segment_offset.hex", &startaddress, &g_firstaddress, &g_lastaddress, NULL, NULL);
    CU_ASSERT(retval == e_ihex_success);
    CU_ASSERT(startaddress == 0x00000000);
...
void IHEXTEST_vTestFileWithSegmentStartAddress(void)
{
    ...
    g_firstaddress = 0xFFFFFFFF; g_lastaddress = 0x00000000;
    // successfully read an ihex file without saving the data
    retval = ihex_read_file("testdata/ihex/data_with_segment_startaddress.hex", &startaddress, &g_firstaddress, &g_lastaddress, NULL, NULL);
    CU_ASSERT(retval == e_ihex_success);
...
void IHEXTEST_vTestFileWithLinearOffset(void)
{
    ...
    g_firstaddress = 0xFFFFFFFF; g_lastaddress = 0x00000000;
    // successfully read an ihex file without saving the data
    retval = ihex_read_file("testdata/ihex/data_with_linear_offset.hex", &startaddress, &g_firstaddress, &g_lastaddress, NULL, NULL);
    CU_ASSERT(retval == e_ihex_success);
    CU_ASSERT(startaddress == 0x00000000);
...
void IHEXTEST_vTestFileWithLinearStartAddress(void)
{
    ...
    g_firstaddress = 0xFFFFFFFF; g_lastaddress = 0x00000000;
    // successfully read an ihex file without saving the data
    retval = ihex_read_file("testdata/ihex/data_with_linear_startaddress.hex", &startaddress, &g_firstaddress, &g_lastaddress, NULL, NULL);
    CU_ASSERT(retval == e_ihex_success);
...
{
    int32_t retval;
    retval = ihex_read_file("filenotexisting.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/unexpected_char.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/unexpected_eol.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/unexpected_eof.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/invalidlinemark.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/charsateol.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/invalidrectype.hex", NULL, NULL, NULL, NULL, NULL);
...
{
    int32_t retval;
    retval = ihex_read_file("testdata/ihex/invalidchecksum.hex", NULL, NULL, NULL, NULL, NULL);
