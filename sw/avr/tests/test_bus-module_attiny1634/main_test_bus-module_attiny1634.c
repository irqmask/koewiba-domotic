 ...
 *
 * @{
 * @file    main_basic_app_attiny1634.c
 * @brief   Test hardware of bus-module_attiny1634.
 * 
 * Test hardware of bus-module_attiny1634:
 *  - EEProm 
...
int main(void)
{
    ...
    //register_set_u8(MOD_eReg_ModuleID, 15);
