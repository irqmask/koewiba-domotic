...
ifeq ($(OS),Windows_NT)
	$(AVRDUDE) $(AVRDUDE_FLAGS) $(WAVRDUDE_WRITE_FLASH_DEBUG) $(WAVRDUDE_WRITE_EEPROM_DEBUG)
else
...
ifeq ($(OS),Windows_NT)
	$(AVRDUDE) $(AVRDUDE_FLAGS) $(WAVRDUDE_WRITE_FLASH_RELEASE) $(WAVRDUDE_WRITE_EEPROM_RELEASE)
else
