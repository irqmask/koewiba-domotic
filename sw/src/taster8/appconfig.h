...
typedef enum appregisters {
    ...
    APP_eReg_0_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_1_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_2_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_3_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_4_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_5_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_6_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_7_Mode,            //!< Mode (dimmer/switch)
    APP_eReg_0_RemoteAddr0,
    APP_eReg_1_RemoteAddr0,
    APP_eReg_2_RemoteAddr0,
    APP_eReg_3_RemoteAddr0,
    APP_eReg_4_RemoteAddr0,
    APP_eReg_5_RemoteAddr0,
    APP_eReg_6_RemoteAddr0,
    APP_eReg_7_RemoteAddr0,
    APP_eReg_0_RemoteAddr1,
    APP_eReg_1_RemoteAddr1,
    APP_eReg_2_RemoteAddr1,
    APP_eReg_3_RemoteAddr1,
    APP_eReg_4_RemoteAddr1,
    APP_eReg_5_RemoteAddr1,
    APP_eReg_6_RemoteAddr1,
    APP_eReg_7_RemoteAddr1,
    ...
    APP_eReg_0_TgtChn0,         //!< Channel 0 target value, e.g. brightness
    APP_eReg_1_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_2_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_3_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_4_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_5_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_6_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_7_TgtChn0,         //!< Channel 0 target value, e.g. red lamp brightness
    APP_eReg_0_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_1_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_2_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_3_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_4_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_5_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_6_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_7_TgtChn1,         //!< Channel 1 target value, e.g. green lamp brightness
    APP_eReg_0_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_1_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_2_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_3_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_4_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_5_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_6_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_7_TgtChn2,         //!< Channel 2 target value, e.g. blue lamp brightness
    APP_eReg_0_RemChn0,         //!< Channel 0 remote value, e.g. lamp brightness
    APP_eReg_1_RemChn0,         //!< Channel 0 remote value
    APP_eReg_2_RemChn0,         //!< Channel 0 remote value
    APP_eReg_3_RemChn0,         //!< Channel 0 remote value
    APP_eReg_4_RemChn0,         //!< Channel 0 remote value
    APP_eReg_5_RemChn0,         //!< Channel 0 remote value
    APP_eReg_6_RemChn0,         //!< Channel 0 remote value
    APP_eReg_7_RemChn0,         //!< Channel 0 remote value
    APP_eReg_0_RemChn1,         //!< Channel 1 remote value
    APP_eReg_1_RemChn1,         //!< Channel 1 remote value
    APP_eReg_2_RemChn1,         //!< Channel 1 remote value
    APP_eReg_3_RemChn1,         //!< Channel 1 remote value
    APP_eReg_4_RemChn1,         //!< Channel 1 remote value
    APP_eReg_5_RemChn1,         //!< Channel 1 remote value
    APP_eReg_6_RemChn1,         //!< Channel 1 remote value
    APP_eReg_7_RemChn1,         //!< Channel 1 remote value
    APP_eReg_0_RemChn2,         //!< Channel 2 remote value
    APP_eReg_1_RemChn2,         //!< Channel 2 remote value
    APP_eReg_2_RemChn2,         //!< Channel 2 remote value
    APP_eReg_3_RemChn2,         //!< Channel 2 remote value
    APP_eReg_4_RemChn2,         //!< Channel 2 remote value
    APP_eReg_5_RemChn2,         //!< Channel 2 remote value
    APP_eReg_6_RemChn2,         //!< Channel 2 remote value
    APP_eReg_7_RemChn2,         //!< Channel 2 remote value
...
typedef enum appconfig {
    ...
    APP_eCfg_6_Mode,
    APP_eCfg_7_Mode,
    APP_eCfg_0_RemoteAddr0,
    APP_eCfg_0_RemoteAddr0Low = APP_eCfg_0_RemoteAddr0,
    APP_eCfg_0_RemoteAddr0High,
    APP_eCfg_1_RemoteAddr0,
    APP_eCfg_1_RemoteAddr0Low = APP_eCfg_1_RemoteAddr0,
    APP_eCfg_1_RemoteAddr0High,
    APP_eCfg_2_RemoteAddr0,
    APP_eCfg_2_RemoteAddr0Low = APP_eCfg_2_RemoteAddr0,
    APP_eCfg_2_RemoteAddr0High,
    APP_eCfg_3_RemoteAddr0,
    APP_eCfg_3_RemoteAddr0Low = APP_eCfg_3_RemoteAddr0,
    APP_eCfg_3_RemoteAddr0High,
    APP_eCfg_4_RemoteAddr0,
    APP_eCfg_4_RemoteAddr0Low = APP_eCfg_4_RemoteAddr0,
    APP_eCfg_4_RemoteAddr0High,
    APP_eCfg_5_RemoteAddr0,
    APP_eCfg_5_RemoteAddr0Low = APP_eCfg_5_RemoteAddr0,
    APP_eCfg_5_RemoteAddr0High,
    APP_eCfg_6_RemoteAddr0,
    APP_eCfg_6_RemoteAddr0Low = APP_eCfg_6_RemoteAddr0,
    APP_eCfg_6_RemoteAddr0High,
    APP_eCfg_7_RemoteAddr0,
    APP_eCfg_7_RemoteAddr0Low = APP_eCfg_7_RemoteAddr0,
    APP_eCfg_7_RemoteAddr0High,
    APP_eCfg_0_RemoteAddr1,
    APP_eCfg_0_RemoteAddr1Low = APP_eCfg_0_RemoteAddr1,
    APP_eCfg_0_RemoteAddr1High,
    APP_eCfg_1_RemoteAddr1,
    APP_eCfg_1_RemoteAddr1Low = APP_eCfg_1_RemoteAddr1,
    APP_eCfg_1_RemoteAddr1High,
    APP_eCfg_2_RemoteAddr1,
    APP_eCfg_2_RemoteAddr1Low = APP_eCfg_2_RemoteAddr1,
    APP_eCfg_2_RemoteAddr1High,
    APP_eCfg_3_RemoteAddr1,
    APP_eCfg_3_RemoteAddr1Low = APP_eCfg_3_RemoteAddr1,
    APP_eCfg_3_RemoteAddr1High,
    APP_eCfg_4_RemoteAddr1,
    APP_eCfg_4_RemoteAddr1Low = APP_eCfg_4_RemoteAddr1,
    APP_eCfg_4_RemoteAddr1High,
    APP_eCfg_5_RemoteAddr1,
    APP_eCfg_5_RemoteAddr1Low = APP_eCfg_5_RemoteAddr1,
    APP_eCfg_5_RemoteAddr1High,
    APP_eCfg_6_RemoteAddr1,
    APP_eCfg_6_RemoteAddr1Low = APP_eCfg_6_RemoteAddr1,
    APP_eCfg_6_RemoteAddr1High,
    APP_eCfg_7_RemoteAddr1,
    APP_eCfg_7_RemoteAddr1Low = APP_eCfg_7_RemoteAddr1,
    APP_eCfg_7_RemoteAddr1High,
    APP_eCfg_Last
} eConfiguration_t;
