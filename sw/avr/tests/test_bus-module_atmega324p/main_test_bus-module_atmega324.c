/**
 * @addtogroup TEST_BUS-MODULE_ATMEGA324
 *
 * @{
 * @file    main_test_bus-module_atmega324.c
 * @brief   Test hardware of bus-module_atmega324.
 * 
 * Test hardware of bus-module_atmega324:
 *  - EEProm 
...
int main(void)
{
    ...
    //register_set_u8(MOD_eReg_ModuleID, 4);
